# Changelog
## [Next]
- Fixed Marstek Jupiter devices (JPLS, HMM, HMN) whose firmware version contains a decimal point, such as 150.5, being placed on the wrong cloud connection. Jupiter ships two firmware lines and the shape of the reported version, not just its value, decides which one a device is on
